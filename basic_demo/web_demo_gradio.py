...
# MODEL_PATH = os.environ.get('MODEL_PATH', r'C:\Users\Admin\.cache\modelscope\hub\ZhipuAI\chatglm3-6b')
MODEL_PATH = os.environ.get('MODEL_PATH', r'E:\models\qiuertest')
...
with gr.Blocks() as demo:
    gr.HTML("""<h1 align="center">QiuerModel-6B Gradio Simple Demo</h1>""")
    chatbot = gr.Chatbot()
